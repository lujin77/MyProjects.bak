...
#ifndef soapHttpServiceSoapProxy_H
#define soapHttpServiceSoapProxy_H
#include "soapH.h"
class HttpServiceSoap
{   public:
	/// Runtime engine context allocated in constructor
	struct soap *soap;
	/// Endpoint URL of service 'HttpServiceSoap' (change as needed)
	const char *endpoint;
	/// Constructor allocates soap engine context, sets default endpoint URL, and sets namespace mapping table
	HttpServiceSoap()
	{ soap = soap_new(); endpoint = "http://220.165.8.124:2557/QueryService.asmx"; if (soap && !soap->namespaces) { static const struct Namespace namespaces[] = 
{
	...
	virtual ~HttpServiceSoap() { if (soap) { soap_destroy(soap); soap_end(soap); soap_free(soap); } };
	/// Invoke 'queryPhoneNOInfo' of service 'HttpServiceSoap' and return error code (or SOAP_OK)
